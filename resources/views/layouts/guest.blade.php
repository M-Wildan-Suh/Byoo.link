...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased"
        ...
        <div class=" w-screen h-screen flex items-center justify-center bg-gradient-to-br from-byolink-1 to-byolink-3 px-4 py-4">
            <div class=" w-full max-w-4xl mx-auto">
                <div
                    class=" w-full max-h-[calc(100vh-32px)] md:aspect-[3/2] p-4 grid grid-cols-1 md:grid-cols-2 gap-4 shadow-md shadow-black/20 rounded-md overflow-hidden bg-white">
                    <div class=" hidden md:flex rounded-md overflow-hidden relative">
                        <img src="{{asset('assets/images/guest.png')}}" class=" w-full h-full object-contain" alt="">
                        <div class=" absolute w-full h-full top-0 left-0 bg-byolink-1/10"></div>
                    </div>
