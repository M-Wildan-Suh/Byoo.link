<x-guest-layout>
    ...
    <div class=" w-full relative flex justify-center">
        <a href="{{ route('register') }}" class=" text-sm absolute top-0 right-0 text-neutral-600 hover:text-byolink-3 duration-300">Daftar</a>
        <p class=" text-2xl font-black text-byolink-3">Login</p>
    </div>
