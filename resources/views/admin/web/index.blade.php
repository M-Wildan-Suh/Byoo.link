            ...
            <table class="w-full text-sm sm:text-base rounded-md overflow-hidden">
                <thead>
                    <tr class="h-10 bg-byolink-1 text-white divide-x-2 divide-white">
                        <th class=" px-1 sm:px-2 py-1 w-1/3">Nama</th>
                        <th class=" px-1 sm:px-2 py-1 w-1/3">Tipe</th>
                ...
                <tbody>
                    <template x-for="(item, index) in paginatedData" :key="index">
                        <tr :class="index % 2 === 0 ? 'bg-neutral-100' : 'bg-neutral-200'"
                            ...
                            <td class=" px-2 sm:px-4 py-2 text-center font-semibold" x-text="item.title"></td>
                            <td class=" px-2 sm:px-4 py-2 text-center" x-text="item.type"></td>
                            <td class=" px-1 sm:px-2">
                                <div class="flex gap-2 justify-center">
                                    <!-- Detail -->
                                    <a :href="`{{ route('web.download', '') }}/${item.id}`" class="w-5 h-5 hover:text-blue-500 duration-300" @click="loading = true; setTimeout(() => { loading = false; }, 3000)">
                                        <svg viewBox="0 0 384 512" class=" w-full h-full" xmlns="http://www.w3.org/2000/svg"><path d="M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm76.45 211.36-96.42 95.7c-6.65 6.61-17.39 6.61-24.04 0l-96.42-95.7C73.42 337.29 80.54 320 94.82 320H160v-80c0-8.84 7.16-16 16-16h32c8.84 0 16 7.16 16 16v80h65.18c14.28 0 21.4 17.29 11.27 27.36zM377 105 279.1 7c-4.5-4.5-10.6-7-17-7H256v128h128v-6.1c0-6.3-2.5-12.4-7-16.9z" fill="currentColor" class="fill-000000"></path></svg>
                                    </a>
